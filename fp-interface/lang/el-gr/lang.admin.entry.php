...
$lang ['admin'] ['entry'] ['commentlist'] = array(
	...
	'descr' => 'Εδώ μπορείτε να επεξεργαστείτε ή να διαγράψετε σχόλια.',
	'sel' => 'Sel',
	'content' => 'Περιεχόμενο',
	'date' => 'Ημερομηνία',
	'author' => 'Συντάκτης',
...
$lang ['admin'] ['entry'] ['commedit'] = array(
	...
	'descr' => 'Εδώ μπορείτε να επεξεργαστείτε το σχόλιο, το όνομα, τη διεύθυνση ηλεκτρονικού ταχυδρομείου και τον ιστότοπο ενός συγγραφέα όπως επιθυμείτε.<br><br>',
	'content' => 'Περιεχόμενο',
	'date' => 'Ημερομηνία',
	'author' => 'Συντάκτης',
	'www' => 'Ιστοσελίδα',
	'email' => 'Ηλ. ταχυδρομείο',
	'ip' => 'IP',
	'loggedin' => 'Συνδεδεμένος διαχειριστής',
	'submit' => 'Αποθήκευση',
