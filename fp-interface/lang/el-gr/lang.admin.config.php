...
$lang ['admin'] ['config'] ['default'] = array(
	...
	'adminpassword' => 'Νέος κωδικός πρόσβασης',
	'adminpasswordconfirm' => 'Επανάληψη κωδικού πρόσβασης',
...
$lang ['admin'] ['config'] ['default'] ['msgs'] = array(
	...
	2 => 'Ο διαχειριστής έχει αλλάξει. Τώρα θα αποσυνδεθείτε.',
...
$lang ['admin'] ['config'] ['default'] ['error'] = array(
	...
	'admin' => 'Το όνομα του διαχειριστή μπορεί να περιέχει μόνο γράμματα, αριθμούς και 1 υπογράμμιση.',
	'password' => 'Ο κωδικός πρόσβασης πρέπει να περιέχει τουλάχιστον 6 χαρακτήρες και δεν πρέπει να περιέχει κενά.',
	'confirm_password' => 'Οι κωδικοί πρόσβασης δεν ταιριάζουν.'
);
?>
