...
$lang ['admin'] ['config'] ['default'] = array(
	...
	'adminpassword' => 'Новый пароль',
	'adminpasswordconfirm' => 'Повторить пароль',
...
$lang ['admin'] ['config'] ['default'] ['msgs'] = array(
	...
	2 => 'Администратор был изменен. Теперь вы выйдете из системы.',
...
$lang ['admin'] ['config'] ['default'] ['error'] = array(
	...
	'admin' => 'Имя администратора может содержать только буквы, цифры и 1 знак подчеркивания.',
	'password' => 'Пароль должен содержать не менее 6 символов и не должен содержать пробелов.',
