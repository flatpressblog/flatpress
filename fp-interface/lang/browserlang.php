 ...
 *
 * @param array Allowed Languages "array('cs-cz','de-de','en-us','es-es',fr-fr','it-it','ja-jp','nl-nl','pt-br','sl-si')"
...
$browserLang = getBrowserLanguage(array('cs-cz', 'de-de', 'en-us', 'es-es', 'fr-fr', 'it-it', 'ja-jp', 'nl-nl', 'pt-br', 'sl-si'), 'en-us');
