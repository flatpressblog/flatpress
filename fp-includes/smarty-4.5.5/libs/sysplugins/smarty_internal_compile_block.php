...
class Smarty_Internal_Compile_Blockclose extends Smarty_Internal_Compile_Shared_Inheritance
{
    ...
    public function compile($args, Smarty_Internal_TemplateCompilerBase $compiler, $parameter)
    {
        ...
        // Helper function for quoting dynamic values
        $quoteIfNeeded = function ($val) {
            if (preg_match('/^["\'].*["\']$/', $val)) {
                return $val;
            }
        ...
        $_nameRaw = $_attr['name'];
        $_name = $quoteIfNeeded($_nameRaw);
        $_assign = isset($_attr['assign']) ? $quoteIfNeeded($_attr['assign']) : null;
        ...
        // Beginning of code
        $output = "<?php\n";
        $output .= $compiler->cStyleComment(' {block ' . $_nameRaw . '} ') . "\n";
        ...
        $compiler->parser->current_buffer->append_subtree(
            $compiler->parser,
            new Smarty_Internal_ParseTree_Tag($compiler->parser, $output)
        );
