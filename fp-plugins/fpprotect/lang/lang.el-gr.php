...
' . //
	...
	'session_timeout_label' => 'Χρονικό όριο αδράνειας για τη συνεδρία διαχειριστή (λεπτά)',
	'session_timeout_desc' => 'Λεπτά αδράνειας μέχρι τη λήξη της συνεδρίας διαχειριστή. Κενό ή 0 σημαίνει προεπιλεγμένα 60 λεπτά.',
