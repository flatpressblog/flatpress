...
' . //
	...
	'allow_external_iframe' => 'Επιτρέψτε την ενσωμάτωση εξωτερικού περιεχομένου μέσω iFrame (δεν συνιστάται).',
	'allowExternalIframeDsc' => 'Επιτρέπει την ενσωμάτωση εξωτερικού περιεχομένου μέσω της ετικέτας <code>&lt;iframe&gt;</code> (π.χ. βίντεο, χάρτες, widget). ' . //
		'Το ενσωματωμένο περιεχόμενο τρίτων μπορεί να παρακολουθεί τους επισκέπτες και ενδέχεται να μην είναι ασφαλές. Ενεργοποιήστε το μόνο αν το χρειάζεστε πραγματικά.',

	// Part for SVG uploads via admin uploader
	'allow_svg_upload' => 'Επιτρέψτε τη μεταφόρτωση αρχείων SVG μέσω του προγράμματος μεταφόρτωσης (μόνο για αξιόπιστους χρήστες).',
	'allowSvgUploadDsc' => 'Επιτρέπει τη μεταφόρτωση αρχείων SVG μέσω του προγράμματος μεταφόρτωσης διαχειριστή. Τα αρχεία SVG ενδέχεται να περιέχουν ενεργό περιεχόμενο (π.χ. σενάρια). Ενεργοποιήστε αυτήν την επιλογή μόνο εάν εμπιστεύεστε τους χρήστες που πραγματοποιούν μεταφόρτωση και δεν ενσωματώνετε αρχεία SVG που δεν είναι αξιόπιστα.',
	...
	'warning_allowExternalIframe' => 'Προειδοποίηση: Content-Security-Policy -> Η ενσωμάτωση εξωτερικού iFrame είναι ενεργοποιημένη. Το ενσωματωμένο περιεχόμενο τρίτων μπορεί να παρακολουθεί τους επισκέπτες και ενδέχεται να μην είναι ασφαλές.',
	'warning_allowSvgUpload' => 'Προειδοποίηση: Τα αρχεία SVG μπορεί να περιέχουν ενεργό περιεχόμενο. Ανεβάστε μόνο αξιόπιστα αρχεία SVG και μην τα ενσωματώνετε χωρίς έλεγχο!',
