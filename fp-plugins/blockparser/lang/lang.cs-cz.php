<?php
	...
	$lang['admin']['widgets']['blockparser'] = array(
		...
		'description'	=> 'BlockParser je plugin, který umožňuje vytvořit widget ze statické stránky. </p><p>
		Zvolte jednu nebo více statických stránek ze seznamu v souladu s odpovídajícím widgetem.</p><p>
		Každá <a href="?p=static&amp;action=write">nová statická stránka</a>, kterou vytvoříte bude uvedena zde.',
