...
$lang ['admin'] ['widgets'] ['blockparser'] = array(
	...
	'description' => 'BlockParser plugin le permite crear un widget desde una página estática. </p>' .
		'<p>Seleccione una o más páginas estáticas de la lista para que el widget correspondiente esté disponible.</p>' .
		'<p>Cada <a href="?p=static&amp;action=write">nueva página estática</a> que cree aparecerá aquí.',
