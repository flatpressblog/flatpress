...
$lang ['admin'] ['uploader'] ['gallerycaptions'] = array(
    ...
    'label_noimagesingallery' => 'Ta galerija še ne vsebuje nobenih slik ¯\_(ツ)_/¯<br>' .
		'<br>Naložite slike preko <a href="' . BLOG_BASEURL . 'admin.php?p=uploader&action=default' . '">Uploader</a>, nato jih dodajte v galerijo z uporabo <a href="' . BLOG_BASEURL . 'admin.php?p=uploader&action=mediamanager' . '">Upravitelja medijev</a>!',
