...
$lang ['admin'] ['uploader'] ['gallerycaptions'] = array(
	...
	'label_noimagesingallery' => 'This gallery doesn´t contain any images yet ¯\_(ツ)_/¯<br>' . //
		'<br>Upload images via the <a href="' . BLOG_BASEURL . 'admin.php?p=uploader&action=default' . '">Uploader</a>, then add them to the gallery using the <a href="' . BLOG_BASEURL . 'admin.php?p=uploader&action=mediamanager' . '">Media Manager</a>!',
