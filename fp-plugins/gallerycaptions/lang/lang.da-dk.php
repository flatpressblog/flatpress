...
$lang ['admin'] ['uploader'] ['gallerycaptions'] = array(
	...
	'label_noimagesingallery' => 'Dette galleri indeholder endnu ikke nogen billeder ¯\_(ツ)_/¯<br>' .
		'<br>Upload nogle med <a href="' . BLOG_BASEURL . 'admin.php?p=uploader&action=default' . '">Uploader</a>, og tildel dem derefter til galleriet med <a href="' . BLOG_BASEURL . 'admin.php?p=uploader&action=mediamanager' . '">Media Manager</a>!',
