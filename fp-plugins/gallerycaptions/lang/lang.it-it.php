...
<br>
Carica le immagini attraverso il <a href="' . BLOG_BASEURL . 'admin.php?p=uploader&action=default' . '">Caricatore</a>, poi aggiungile alla galleria usando il <a href="' . BLOG_BASEURL . 'admin.php?p=uploader&action=mediamanager' . '">Media Manager</a>!',
