			...
			<tr>
				<td>
					<a class="bbcode-popup" href="{$smarty.const.BLOG_BASEURL}{$smarty.const.IMAGES_DIR}{$currentgallery}/{$currentfilename}">
						<img src="{$smarty.const.BLOG_BASEURL}{$smarty.const.IMAGES_DIR}{$currentgallery}/{$currentfilename}" alt="{$currentfilename}" title="{$currentfilename}" style="width: 320px" loading="lazy">
					</a>
					<br>
					{$currentfilename}
				</td>
