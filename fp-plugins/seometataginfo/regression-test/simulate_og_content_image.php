 ...
 * gallery_read_images() helper, the patched ReadMore boundary helper and the
...
try {
	...
	// Gallery where first sorted file is not an image.
	...
	$meta = seometataginfo_find_first_content_image_meta('[img="https://cdn.example.test/original.jpg" width="20"]', $base, false);
	...
	$GLOBALS ['regression_entries'] = array(
		'e1' => array('content' => 'Intro [more] [img="images/after-more.png"]'),
		'e2' => array('content' => '[img="images/second.png"]')
	);
	$meta = seometataginfo_get_stream_content_image_meta($base);
