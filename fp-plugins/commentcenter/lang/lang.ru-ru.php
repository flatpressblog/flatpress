...
$lang ['plugin'] ['commentcenter'] = array(
	...
	'akismet_spam'  => 'Ваш комментарий был распознан как спам.',
...
Войдите в административную часть вашего блога FlatPress и проверьте заблокированный комментарий в центре комментариев.
