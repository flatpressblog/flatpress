...
$lang ['step3'] = array(
	...
	'descr' => '<strong>安装完成</strong>。
		...
		不过这是真的：博客的精彩故事才刚刚开始，接下来就看您的创作了！

		<ul>
		<li>查看<a href="%s">首页现在的样子</a></li>
		<li>祝您使用愉快！<a href="%s">立即登录</a></li>
		<li>想联系我们吗？欢迎访问 <a href="https://www.flatpress.org/" target="_blank" rel="external">FlatPress.org</a>！</li>
		</ul>
...
侧边栏中的元素并不是固定不变的。您在本文周围区域看到的所有元素都可以自由定位，而且其中大多数也可以自定义。有些主题甚至会在管理区域中提供设置面板。
...
[*]从 [url=https://wiki.flatpress.org/res:themes target=_blank rel=external]其他用户贡献的作品[/url] 中获取 [b]优秀主题[/b]！
...
启用 CookieBanner 插件后，访问者可以通过联系表单或评论功能直接访问此页面。
';
?>
