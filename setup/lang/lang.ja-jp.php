...
サイドバーには固定された部品が1つもありません。この記事欄周辺のサイドバー上にある部品は、すべて自由に配置でき、そのほとんどはカスタマイズ可能です。その機能によっては、管理者用ページに設定用パネルが用意されているものもあります。
...
[*][b]他のユーザから投稿[/b]された [url=https://wiki.flatpress.org/res:themes target=_blank rel=external]素晴らしいテーマ[/url] を入手しましょう!
