...
// FlatPress core: This includes this file, recursively the directories FP_INCLUDES, CONFIG_DIR, USERS_DIR, LANG_DIR and SHARED_TPLS
...
// For all other files and directories, e.g. ADMIN_DIR, FP_INTERFACE, THEMES_DIR and PLUGINS_DIR
