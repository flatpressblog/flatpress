...
- Admin area login:
  ...
  - The clear name is no longer transmitted in the fpuser cookie. Admin login and authentication via PHP sessions. ([#488](https://github.com/flatpressblog/flatpress/pull/488))
- Admin area generel:
