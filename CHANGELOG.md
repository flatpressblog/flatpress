...
- Admin area: Optional natural sorting for static pages ([#455](https://github.com/flatpressblog/flatpress/pull/455))
...
(https://github.com/flatpressblog/flatpress/issues/422))
- Admin area:
  ...
  - Upload panel: More resistant to RCE attacks and traversal attacks ([#451](https://github.com/flatpressblog/flatpress/issues/451))
  ...
  - Widget management: Scripts equipped with a nonce to enable stricter [CSP](https://en.wikipedia.org/wiki/Content_Security_Policy) ([#422]
