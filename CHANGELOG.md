...
## General
- Template engine Smarty updated to version 4.5.4 ([#376](https://github.com/flatpressblog/flatpress/pull/376), [#390](https://github.com/flatpressblog/flatpress/issues/390))
...
- Admin area generel:
  ...
  - Cross-site scripting (XSS) vulnerability in the international settings ("Character set" field) closed. ([#340](https://github.com/flatpressblog/flatpress/issues/340))
  - Upload of hidden files is no longer possible. ([#486](https://github.com/flatpressblog/flatpress/pull/486))
  - XSS vulnerabilities in the configuration menu -> International settings closed. ([#487](https://github.com/flatpressblog/flatpress/pull/487))
