...
- BBcode, PhotoSwipe and Emoticons plugin: Scripts equipped with a nonce to enable stricter CSP ([#422](https://github.com/flatpressblog/flatpress/issues/422))
- Admin area widget management: Scripts equipped with a nonce to enable stricter CSP ([#422](https://github.com/flatpressblog/flatpress/issues/422))
