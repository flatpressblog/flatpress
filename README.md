...
- Supported languages: [🇨🇿](## "Čeština") [🇺🇸](## "English") [🇩🇰](## "Dansk") [🇩🇪](## "Deutsch") [🇪🇸](## "Español") [🇫🇷](## "Français") [🇬🇷](## "Ελληνικά") [🇮🇹](## "Italiano") [🇯🇵](## "日本語") [🇳🇱](## "Nederlands") [🇧🇷](## "Português Brasileiro") [🇷🇺](## "Русский") [🇸🇮](## "Slovenski") (easy to add yours!)
